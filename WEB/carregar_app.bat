...
:DO_BATCH
REM if exist download.link del download.link
REM mklink download.link ..\SDK\SDK_Export\lwip_example_hw_platform\download.bit
...
REM if exist raw_apps.link del raw_apps.link
REM mklink raw_apps.link ..\SDK\SDK_Export\raw_apps\Debug\raw_apps.elf
